...
public class SQLite {
    ...
    private Integer numberOfColsInLogTable = columns.values().length;
    ...
    public SQLite(String databaseUrlJdbc, String cleanDatabaseTableAtStart) {
        ...
        //source: https://shinesolutions.com/2007/08/04/how-to-close-jdbc-resources-properly-every-time/
        ...
        try {
            ...
            try {
                ...
                if (tables.next()) {
                    ...
                    //find out how many columns is in currently saved table stagpdfa_logs and how many columns is in enum Columns, if numbers are not same drop old table "stagpdfa_logs" and create new using sqlCreateQuery
    ...
    public void updateStagpdfaLogs(String verapdf_rest_response, Integer request_time, Integer verapdf_rest_request_time, Integer status_code, String error_message, Timestamp datetime) {
        ...
        try {
            ...
            try {
                ...
                //source: https://stackoverflow.com/questions/17207088/how-to-use-java-variable-to-insert-values-to-mysql-table
